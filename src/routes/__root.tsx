...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium curtains, elegant handbags and fashionable ladies' shoes — thoughtfully curated at Eloria Store." },
      { name: "author", content: "Eloria Store" },
      { property: "og:title", content: "Eloria Store · Style Your Home. Elevate Your Wardrobe." },
      { property: "og:description", content: "Premium curtains, elegant handbags and fashionable ladies' shoes." },
