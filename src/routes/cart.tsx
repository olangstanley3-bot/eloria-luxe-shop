          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_360px]">
            ...
            <aside className="h-fit rounded-3xl border border-border bg-secondary/30 p-6">
              ...
              <div className="mt-5">
                ...
                <div className="mt-2 flex gap-2">
                  <input
                    ...
                    placeholder="Try ELORIA10"
                    className="flex-1 rounded-full border border-border bg-background px-4 py-2 text-sm outline-none"
                  />
                  <button
                    onClick={applyCoupon}
                    className="rounded-full bg-charcoal px-4 py-2 text-xs uppercase tracking-widest text-cream"
                  >
                    Apply
                  </button>
                </div>
                {discount > 0 && (
                  <p className="mt-2 text-xs text-champagne-deep">10% discount applied.</p>
                )}
              </div>
              ...
              <dl className="mt-6 space-y-2 text-sm">
                ...
                {discount > 0 && (
                  <div className="flex justify-between text-champagne-deep">
                    <dt>Discount</dt>
                    <dd>−{formatKES(Math.round(subtotal * discount))}</dd>
                  </div>
                )}
                <div className="flex justify-between">
                  <dt>Shipping</dt>
                  <dd>{shipping === 0 ? "Complimentary" : formatKES(shipping)}</dd>
                </div>
              </dl>
              ...
              <button
                ...
                className="mt-6 w-full rounded-full bg-primary py-3.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition"
              >
                Secure checkout
              </button>
